...
<table class="table table-striped">
  ...
  <input type="hidden" name="id_pegawai" value="<?= $peg['id_pegawai'] ?>">
	<tr><td>Nama Staff</td><th><input type="text" value="<?= $peg['nama'] ?>" name="id_pegawai" class="form-control" value="<?= $peg['id_pegawai'] ?>" disabled></th></tr>
    ...
    <tr><td>Status</td><td><input type="text" value="<?= $peg['status_kep'] ?>" class="form-control" disabled></td></tr>
