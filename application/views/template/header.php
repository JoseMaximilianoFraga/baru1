...
if($this->session->userdata('level') =="admin"){
 ...
 $id  = $this->session->userdata('id_admin');
 $data= $this->db->get_where('admin',array('id_admin'=>$id))->row_array();
}elseif($this->session->userdata('level') =="topmanajemen"){
  $id  = $this->session->userdata('id_admin');
  $data= $this->db->get_where('admin',array('id_admin'=>$id))->row_array();
 }
?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?= base_url('admin/keluar') ?>" onclick="return(confirm('Anda Yakin Akan Keluar?'))" class="btn btn-default btn-flat">Logout</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/pegawai') ?>" class="active"><i class="fa fa-circle-o"></i>Staff</a></li>
            <li><a href="<?= base_url('admin/jabatan') ?>"><i class="fa fa-circle-o"></i>Jabatan</a></li>
            <li><a href="<?= base_url('admin/tim') ?>" class="active"><i class="fa fa-circle-o"></i>Tim</a></li>
          </ul>
        </li>
  ...
  <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/pesanan') ?>" class="active"><i class="fa fa-circle-o"></i>Pesanan</a></li>
          </ul>
        </li>
</li>      
  <li class="treeview">
  ...
  <ul class="treeview-menu">
      <li><a href="<?= base_url('penugasan/index') ?>" class="active"><i class="fa fa-circle-o"></i>Penugasan</a></li>
          </ul>
        </li>
</li>      
  
<li class="treeview">
  <a href="<?= base_url('admin/penilaian_kinerja') ?>">
    <i class="fa fa-star"></i> <span>Penilaian Kinerja</span>
    <i class="fa fa-angle-left pull-right"></i>
  </a>
  <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/penilaian_kinerja') ?>" class="active"><i class="fa fa-circle-o"></i>Penilaian Kinerja</a></li>
          </ul>
        </li>
</li>      
...
<li class="treeview">
          ...
          <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/absensi') ?>" class="active"><i class="fa fa-circle-o"></i>Absensi</a></li>
          </ul>
        </li>
 ...
 <li class="treeview">
          <a href="#">
            ...
            <span>Pembagian Insentif</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/tpp'); ?>"><i class="fa fa-circle-o"></i>Pembagian Insentif</a></li>
          </ul>
        </li>   
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('laporan/laporan_pegawai'); ?>"><i class="fa fa-circle-o"></i> Data Staff</a></li>
             <li><a href="<?= base_url('laporan/laporan_absensi'); ?>"><i class="fa fa-circle-o"></i> Data Absensi</a></li>
              <li><a href="<?= base_url('laporan/laporan_tpp'); ?>"><i class="fa fa-circle-o"></i> Data Insentif</a></li>
              <li><a href="<?= base_url('laporan/laporan_riwayat_pesanan'); ?>"><i class="fa fa-circle-o"></i> Riwayat Pesanan</a></li>
  ...
  <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('laporan/laporan_pegawai'); ?>"><i class="fa fa-circle-o"></i> Data Pegawai</a></li>
             <li><a href="<?= base_url('laporan/laporan_absensi'); ?>"><i class="fa fa-circle-o"></i> Data Absensi</a></li>
              <li><a href="<?= base_url('laporan/laporan_tpp'); ?>"><i class="fa fa-circle-o"></i> Data Pendapatan</a></li>
...
<?php }elseif($this->session->userdata('level') == "pegawai"){ ?>
 ...
 <li class="treeview">
        ...
        <li class="treeview">
  <a href="<?= base_url('admin/pesanan') ?>">
    <i class="fa fa-users"></i> <span>Cek Penugasan</span>
    <i class="fa fa-angle-left pull-right"></i>
  </a>
  <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/tabel_penugasan_pegawai') ?>" class="active"><i class="fa fa-circle-o"></i>Cek Penugasan</a></li>
          </ul>
        </li>
</li>      
...
<?php }elseif($this->session->userdata('level') == "topmanajemen"){ ?>
  ...
  <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/pesanan_top_manajemen') ?>" class="active"><i class="fa fa-circle-o"></i>Pesanan</a></li>
          </ul>
        </li>

        <li class="treeview">
  <a href="<?= base_url('admin/penilaian_kinerja') ?>">
    <i class="fa fa-bar-chart"></i> <span>Penilaian Kinerja</span>
    <i class="fa fa-angle-left pull-right"></i>
  </a>
  <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/penilaian_kinerja') ?>" class="active"><i class="fa fa-circle-o"></i>Penilaian Kinerja</a></li>
...
<?php } ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Midodaren Wedding Organizer</small>
      </h1>
      <ol class="breadcrumb">
